...
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_blit_swapchain,                MENU_ENUM_SUBLABEL_VIDEO_BLIT_SWAPCHAIN)
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_triple_buffering,              MENU_ENUM_SUBLABEL_VIDEO_TRIPLE_BUFFERING)
...
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_video_exclusive_fullscreen,    MENU_ENUM_SUBLABEL_VIDEO_EXCLUSIVE_FULLSCREEN)
      ...
      switch (cbs->enum_idx)
      {
        ...
        case MENU_ENUM_LABEL_PLAY_REPLAY:
         ...
         case MENU_ENUM_LABEL_VIDEO_WINDOWED_FULLSCREEN:
            ...
            break;
         case MENU_ENUM_LABEL_VIDEO_EXCLUSIVE_FULLSCREEN:
            BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_video_exclusive_fullscreen);
            break;
         ...
         case MENU_ENUM_LABEL_VIDEO_WAITABLE_SWAPCHAINS:
            ...
            break;
         case MENU_ENUM_LABEL_VIDEO_BLIT_SWAPCHAIN:
            BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_blit_swapchain);
            break;
         case MENU_ENUM_LABEL_VIDEO_TRIPLE_BUFFERING:
            BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_triple_buffering);
            break;
