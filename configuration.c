      ...
      settings_t *settings, int *size)
{
   ...
   SETTING_BOOL("video_exclusive_fullscreen",    &settings->bools.video_exclusive_fullscreen, true, DEFAULT_EXCLUSIVE_FULLSCREEN, false);
   ...
   SETTING_BOOL("video_blit_swapchain",          &settings->bools.video_blit_swapchain, true, DEFAULT_BLIT_SWAPCHAIN, false);
   SETTING_BOOL("video_triple_buffering",        &settings->bools.video_triple_buffering, true, DEFAULT_TRIPLE_BUFFERING, false);
